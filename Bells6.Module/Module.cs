...
namespace Bells6.Module {
    // For more typical usage scenarios, be sure to check out https://docs.devexpress.com/eXpressAppFramework/DevExpress.ExpressApp.ModuleBase.
    public sealed partial class Bells6Module : ModuleBase {
        static Bells6Module() {
            ...
            // #if DEBUG
            // Database.SetInitializer(new DropCreateDatabaseIfModelChanges<Bells6DbContext>());
            // #endif 
        }
        public Bells6Module() {
            InitializeComponent();
